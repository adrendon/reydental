...
(function() {
	...
	var splitlayout = document.getElementById( 'splitlayout' ),
		leftSide = splitlayout.querySelector( '.intro > .side-left' ),
		rightSide = splitlayout.querySelector( '.intro > .side-right' ),
		pageLeft = splitlayout.querySelector( '.page-left' ),
		pageRight = splitlayout.querySelector( '.page-right' ),
	...
	function init() {
		...
		leftSide.querySelector( '.intro-content' ).addEventListener( eventtype, function( ev ) {
			reset();
			classie.add( splitlayout, 'open-left' );
		} );

		rightSide.querySelector( '.intro-content' ).addEventListener( eventtype, function( ev ) {
			reset();
